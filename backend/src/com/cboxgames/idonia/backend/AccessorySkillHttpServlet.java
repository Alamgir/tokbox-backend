...
/**
 * Handle "/accessory_skills/details"
 * HTTP Method: GET
 * @author Michael Chang
 *
 */
@SuppressWarnings("serial")
public class AccessorySkillHttpServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
    	...
    	String uri_str = request.getRequestURI();
       	if (UriToArgv.verifyUrl(uri_str, "accessory_skills", "details") == false) {
        ...
        ResponseTools.prepareResponseJson(response, _mapper, _db_sql.getAccessorySkillDetails(), Constants.SC_OK);
    }
}