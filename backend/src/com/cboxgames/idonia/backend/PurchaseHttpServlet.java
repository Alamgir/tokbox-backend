...
/**
 * Handle "/purchases/details"
 * HTTP Method: GET
 * @author Michael Chang
 *
 */
@SuppressWarnings("serial")
public class PurchaseHttpServlet extends HttpServlet {

	private SqlDataSource _sql_data_source;
	private PurchaseDBSQL _db_sql;
    ...
    @Override
  	public void init() {
          ...
          try {
              _db_sql = new PurchaseDBSQL(_sql_data_source.get_data_source(), this.getServletContext());
          }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
    	...
    	String uri_str = request.getRequestURI();
       	if (UriToArgv.verifyUrl(uri_str, "purchases", "details") == false) {
        ...
        ResponseTools.prepareResponseJson(response, _mapper, _db_sql.getPurchaseDetails(), Constants.SC_OK);
    }
}