...
/**
 * Handle "/skill_effects/details"
 * HTTP Method: GET
 * @author Michael Chang
 *
 */
@SuppressWarnings("serial")
public class SkillEffectHttpServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
    	...
    	String uri_str = request.getRequestURI();
       	if (UriToArgv.verifyUrl(uri_str, "skill_effects", "details") == false) {
        ...
        ResponseTools.prepareResponseJson(response, _mapper, _db_sql.getSkillEffectDetails(), Constants.SC_OK);
    }
}