...
/**
 * Handle "/mod_skill_effects/details"
 * HTTP Method: GET
 * @author Michael Chang
 *
 */
@SuppressWarnings("serial")
public class MobSkillEffectHttpServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
    	...
    	String uri_str = request.getRequestURI();
       	if (UriToArgv.verifyUrl(uri_str, "mod_skill_effects", "details") == false) {
        ...
        ResponseTools.prepareResponseJson(response, _mapper, _db_sql.getMobSkillEffectDetails(), Constants.SC_OK);
    }
}