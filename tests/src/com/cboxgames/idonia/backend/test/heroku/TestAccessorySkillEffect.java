...
public class TestAccessorySkillEffect extends HttpTest {
	private static String _acc_skill_effect_uri = "/accessory_skill_effects/details"; // HTTP Method: GET
	
	public TestAccessorySkillEffect(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.SERVER_ROOT + _acc_skill_effect_uri));
			...
			Class<AccessorySkillEffectWrapper[]> class_type = AccessorySkillEffectWrapper[].class;
			AccessorySkillEffectWrapper[] unw = IdoniaBackendTest.json_converter.getObject(data, class_type);
			
			// Do some checking here.
			assert unw != null : "Returned AccessorySkillEffect object was null.  Our model is probably missing some fields.";
