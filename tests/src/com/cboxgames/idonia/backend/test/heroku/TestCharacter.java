...
public class TestCharacter extends HttpTest {
	private static String _char_uri = "/characters/details"; // HTTP Method: GET
	
	public TestCharacter(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.SERVER_ROOT + _char_uri));
			...
			Class<CharacterWrapper[]> class_type = CharacterWrapper[].class;
			CharacterWrapper[] unw = IdoniaBackendTest.json_converter.getObject(data, class_type);
			
			// Do some checking here.
			assert unw != null : "Returned Character object was null.  Our model is probably missing some fields.";
