...
public class TestVersion extends HttpTest {
	private static String _version_uri = "/versions/details"; // HTTP method: GET
	
	public TestVersion(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.SERVER_ROOT + _version_uri));
			...
			Class<VersionWrapper[]> class_type = VersionWrapper[].class;
			VersionWrapper[] vw = IdoniaBackendTest.json_converter.getObject(data, class_type);
			
			// Do some checking here.
			assert vw != null : "Returned Version object was null.  Our model is probably missing some fields.";
