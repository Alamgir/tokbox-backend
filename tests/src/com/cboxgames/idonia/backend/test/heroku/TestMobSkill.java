...
public class TestMobSkill extends HttpTest {
	private static String _mob_skill_uri = "/mob_skills/details"; // HTTP Method: GET
	
	public TestMobSkill(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.SERVER_ROOT + _mob_skill_uri));
			...
			Class<MobSkillWrapper[]> class_type = MobSkillWrapper[].class;
			MobSkillWrapper[] unw = IdoniaBackendTest.json_converter.getObject(data, class_type);
			
			// Do some checking here.
			assert unw != null : "Returned MobSkill object was null.  Our model is probably missing some fields.";
