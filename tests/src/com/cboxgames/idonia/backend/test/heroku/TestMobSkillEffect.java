...
public class TestMobSkillEffect extends HttpTest {
	private static String _mob_kill_effect_uri = "/mob_skill_effects/details"; // HTTP Method: GET
	
	public TestMobSkillEffect(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.SERVER_ROOT + _mob_kill_effect_uri));
			...
			Class<MobSkillEffectWrapper[]> class_type = MobSkillEffectWrapper[].class;
			MobSkillEffectWrapper[] unw = IdoniaBackendTest.json_converter.getObject(data, class_type);
			
			// Do some checking here.
			assert unw != null : "Returned MobSkillEffect object was null.  Our model is probably missing some fields.";
