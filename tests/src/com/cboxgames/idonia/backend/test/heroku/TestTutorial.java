...
public class TestTutorial extends HttpTest {
	private static String _tutorial_uri = "/tutorials/details"; // HTTP method: GET
	
	public TestTutorial(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.SERVER_ROOT + _tutorial_uri));
			...
			Class<TutorialWrapper[]> class_type = TutorialWrapper[].class;
			TutorialWrapper[] nw = IdoniaBackendTest.json_converter.getObject(data, class_type);
			
			// Do some checking here.
			assert nw != null : "Returned Tutorial object was null.  Our model is probably missing some fields.";
