...
public class TestUserBanner extends HttpTest {
	private static String _user_banner_uri = "/user_banners/details"; // HTTP method: GET
	
	public TestUserBanner(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.SERVER_ROOT + _user_banner_uri));
