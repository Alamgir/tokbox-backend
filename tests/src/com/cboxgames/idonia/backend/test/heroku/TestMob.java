...
public class TestMob extends HttpTest {
	private static String _mob_uri = "/mobs/details"; // HTTP method: GET
	
	public TestMob(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.SERVER_ROOT + _mob_uri));
			...
			Class<MobWrapper[]> class_type = MobWrapper[].class;
			MobWrapper[] unw = IdoniaBackendTest.json_converter.getObject(data, class_type);
			
			// Do some checking here.
			assert unw != null : "Returned MOb object was null.  Our model is probably missing some fields.";
