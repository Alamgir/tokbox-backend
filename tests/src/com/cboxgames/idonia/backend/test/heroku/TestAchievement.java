...
public class TestAchievement extends HttpTest {
	private static String _achievement_uri = "/achievements/details"; // HTTP Method: GET
	
	public TestAchievement(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.SERVER_ROOT + _achievement_uri));
			...
			Class<AchievementWrapper[]> class_type = AchievementWrapper[].class;
			AchievementWrapper[] unw = IdoniaBackendTest.json_converter.getObject(data, class_type);
			
			// Do some checking here.
			assert unw != null : "Returned Achievement object was null.  Our model is probably missing some fields.";
