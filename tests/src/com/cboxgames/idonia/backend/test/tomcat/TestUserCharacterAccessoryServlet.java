...
public class TestUserCharacterAccessoryServlet extends HttpTest {
	private static String _char_uri = "/user_character_accessories/details"; // HTTP Method: GET
	
	public TestUserCharacterAccessoryServlet(HttpTestRunnable callback_finished, long test_timeout) {
