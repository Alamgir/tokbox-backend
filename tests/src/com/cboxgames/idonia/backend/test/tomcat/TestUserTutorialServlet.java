...
public class TestUserTutorialServlet extends HttpTest {
	private static String _user_tutorial_uri = "/user_tutorials/details"; // HTTP method: GET
	
	public TestUserTutorialServlet(HttpTestRunnable callback_finished, long test_timeout) {
...
//					"missing some fields.";
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.TOMCAT_SERVER_ROOT + _user_tutorial_uri));
			...
			Class<UserTutorialWrapper[]> class_type = UserTutorialWrapper[].class;
			UserTutorialWrapper[] unw = IdoniaBackendTest.json_converter.getObject(data, class_type);
			
			// Do some checking here.
			assert unw != null : "Returned UserTutorial object was null.  Our model is probably missing some fields.";
