...
public class TestUserNodeServlet extends HttpTest {

	private static String _user_node_uri = "/user_nodes/details"; // HTTP Method: GET
	
	public TestUserNodeServlet(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			HttpGet get = new HttpGet(new URI(IdoniaBackendTest.TOMCAT_SERVER_ROOT + _user_node_uri));
