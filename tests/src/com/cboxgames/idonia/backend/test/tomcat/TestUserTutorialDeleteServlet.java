...
public class TestUserTutorialDeleteServlet extends HttpTest {

	private static String _user_tutorial_uri = "/user_tutorials"; // HTTP Method: GET
	
	public TestUserTutorialDeleteServlet(HttpTestRunnable callback_finished, long test_timeout) {
	...
	public void run() {
		try {
			...
			int user_id = 1;
			String url = String.format("%s%s/%d/destroy", IdoniaBackendTest.TOMCAT_SERVER_ROOT, _user_tutorial_uri, user_id);
